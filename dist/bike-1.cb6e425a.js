...
},{"d3-collection":"../node_modules/d3-collection/src/index.js","d3-selection":"../node_modules/d3-selection/src/index.js"}],"data/accidents.csv":[function(require,module,exports) {
module.exports = "/accidents.ca830f75.csv";
},{}],"scripts/bike-1.js":[function(require,module,exports) {
"use strict";
...
var svg = d3.select('#bike-1').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')'); // create scales

var xPositionScale = d3.scaleLinear().domain([0, 100]).range([0, width]);
var yPositionScale = d3.scaleBand().domain(['Bronx', 'Brooklyn', 'Manhattan', 'Queens', 'Staten Island']).range([height, 0]); // Do you need a d3.line function for this? Maybe something similar?

var tip = d3.tip().attr('class', 'd3-tip').offset([-10, 0]).html(function (d) {
  return " <span style='color:black'>".concat(d.count, "</span>");
});
svg.call(tip); // Import your data file using d3.csv

d3.csv(require('../data/accidents.csv')).then(ready).catch(function (err) {
  console.log(err);
});

function ready(datapoints) {
  svg.selectAll('rect').data(datapoints).enter().append('rect').attr('fill', 'lightblue').attr('y', function (d) {
...
},{"d3":"../node_modules/d3/index.js","d3-tip":"../node_modules/d3-tip/index.js","../data/accidents.csv":"data/accidents.csv"}]},{},["scripts/bike-1.js"], null)
//# sourceMappingURL=/bike-1.cb6e425a.js.map